...
export default function HeroSection() {
  ...
  return (
    <>
      {/* 🧠 SEO Meta Tags */}
      <Head>
        <title>Omradix Solutions | Web Development & Digital Growth Partner</title>
        <meta
          name="description"
          content="Omradix Solutions helps startups and businesses build modern websites, boost their online presence, and unlock new growth opportunities. Your success is our mission."
        />
        <meta
          name="keywords"
          content="web development, digital marketing, website design, Omradix Solutions, SEO, business growth, IT company India"
        />
        <meta name="author" content="Omradix Solutions" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://omradixsolutions.vercel.app/" />

        {/* Open Graph (for Facebook / LinkedIn) */}
        <meta property="og:title" content="Omradix Solutions | Web Development & Digital Growth Partner" />
        <meta
          property="og:description"
          content="Partner with Omradix Solutions to build stunning websites and elevate your brand online."
        />
        <meta property="og:image" content="https://omradixsolutions.vercel.app/og-image.jpg" />
        <meta property="og:url" content="https://omradixsolutions.vercel.app/" />
        <meta property="og:type" content="website" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Omradix Solutions | Digital Growth Partner" />
        <meta
          name="twitter:description"
          content="We help you grow online through custom web development and digital strategy."
        />
        <meta name="twitter:image" content="https://omradixsolutions.vercel.app/og-image.jpg" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Omradix Solutions is a web development and digital growth agency helping brands build scalable and stunning online platforms.",
            }),
          }}
        />
      </Head>

      <header id="home" className="relative w-full h-screen flex flex-col items-center justify-between overflow-hidden pt-24 md:pt-0">
        ...
        >
          ...
          <ul className="flex gap-8 text-white font-medium">
            {navLinks.map((link, i) => {
              ...
              return (
                <motion.li key={i} initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1, duration: 0.5 }}>
                  <Link
                    href={link.href}
        ...
        >
          <div className="text-xs font-bold tracking-wide text-white whitespace-nowrap">OMRADIX SOLUTIONS</div>
          <span className="h-5 w-px bg-white/40 mx-3"></span>
          <button aria-label="Toggle menu" onClick={() => setMenuOpen(!menuOpen)} className="p-2">
        ...
        <div className="flex flex-col items-center justify-center text-center px-4 mt-20 md:mt-40 z-20">
          ...
          >
            ...
            <motion.span className="relative z-10" whileHover={{ x: 6 }} transition={{ type: "spring", stiffness: 250 }}>
              ➝
            </motion.span>
          </motion.button>
        </div>
              ...
              {[0.2, 0.35, 0.5, 0.65].map((opacity, i) => {
                ...
                return (
                  <path
                    ...
                    d={`M0,${y} C${width * 0.25},${y - 50} ${width * 0.5},${y + 50} ${width * 0.75},${y} ${width},${y - 50}`}
                    fill="transparent"
                    stroke="white"
                    strokeWidth="2"
        ...
        >
          <h3 className="text-white font-bold text-lg">Trusted By 10+ Businesses.</h3>
          <p className="text-gray-300 max-w-2xl text-sm md:text-base mt-2">
            From Startups To Growing Enterprises, Companies Choose Omradix Solutions To Build Powerful Websites, Boost Their Online Presence, And Create Endless Growth Opportunities.
          </p>

          <div className="flex items-center mt-4">
            {["img1.png", "img2.png", "img3.png", "img4.png"].map((img, i) => (
              <div key={i} className={`w-10 h-10 rounded-full overflow-hidden border-2 border-white ${i === 0 ? "" : "-ml-4"}`}>
                <Image
                  src={`/images/${img}`}
                  alt={`Client ${i + 1} - Trusted business partner`}
                  width={40}
                  height={40}
            ...
            <span className="ml-3 text-gray-300 text-sm">Trusted By 15+ Clients.</span>
          </div>
        </motion.div>
      </header>
    </>
